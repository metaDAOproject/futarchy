...
## {{fonts}}
### {{headings}}
{{geist__semibold__shadow_0_0_7_ffffff66}}

### {{body}}
{{geist__14px}}

### {{label}}
{{geist_mono__tailwind_neutral600_525252__uppercase__12px}}

[{{download_geist_and_geist_mono}}](https://github.com/vercel/geist-font/releases/tag/1.3.0)
