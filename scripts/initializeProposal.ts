...
const FAAS_SQUADS_MULTISIG = new PublicKey("AHwsoL97vXFdvckVZdXw9rrvnUDcPANCLVQzJan9srWy");
...
async function main() {
  ...
  const transferAmount = 342 * 1_000_000_000; // 342 META
  ...
  await initializeProposal(
    ix,
    "https://hackmd.io/@0xNallok/Sk1DjJN2p"
  );
}
